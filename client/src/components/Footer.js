...
const Footer = () => {
  return (
    <div className='w-full h-[300px] bg-[#ffffff] flex flex-col justify-center items-center '>
        <div className='flex w-[60%] justify-between p-5 items-center max-small:flex-col max-small:space-y-6'>
            ...
            <a className='text-xl text-gray-800 hover:text-ACT' href='/termsandconditions'>Terms & Conditions</a>
        </div>
